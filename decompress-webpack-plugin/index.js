...
function DecompressWebpackPlugin(patterns = [], options = {}) {
  if (!Array.isArray(patterns)) {
    throw new Error('[decompress-webpack-plugin] patterns must be an array');
  }
  ...
  function log(msg, level) {
    ...
    if (level <= debugLevelIndex) {
      console.log('[decompress-webpack-plugin] ' + msg); // eslint-disable-line no-console
    }
  }
...
DecompressWebpackPlugin['default'] = DecompressWebpackPlugin;
module.exports = DecompressWebpackPlugin;
